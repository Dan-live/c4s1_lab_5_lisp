...
(defvar *projects* (read-csv-file "d:/University/k4s1/func_prog/Lab_5/final2.com/projects.csv" #'create-project-record))
(defvar *models* (read-csv-file "d:/University/k4s1/func_prog/Lab_5/final2.com/models.csv" #'create-model-record))
...
(write-records-to-csv "d:/University/k4s1/func_prog/Lab_5/final2.com/output.csv" *projects*)
...
(let ((select-projects (select "d:/University/k4s1/func_prog/Lab_5/final2.com/projects.csv" #'create-project-record)))
  (let ((filtered-projects (funcall select-projects '(model-id . 5))))
    (if filtered-projects
        (progn
          ...
          (write-records-to-csv "d:/University/k4s1/func_prog/Lab_5/final2.com/filtered_projects.csv" filtered-projects))
